...
fun TwitterWebViewScreen(
    ...
    class TwitterWebViewScreenState(
    ...
    val screenState = remember { TwitterWebViewScreenState() }
    ...
    val extractAndSetMediaInfo: (String) -> Unit = { pageUrl ->
        if (pageUrl.contains("twitter.com") || pageUrl.contains("x.com")) {
            ...
            scope.launch {
                ...
                screenState.mediaInfo = twitterFetcher.fetchMediaDetails(pageUrl, cookies)
            ...
            screenState.mediaInfo?.let { info ->
                ...
                Box(
                    ...
                    if (screenState.isLoadingMedia) {
                        ...
                        Text(
                            "Navigate to a Twitter/X post to extract media. Login may be required for protected content.",
