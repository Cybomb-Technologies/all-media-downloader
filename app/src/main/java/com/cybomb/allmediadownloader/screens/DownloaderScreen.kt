...
import com.cybomb.allmediadownloader.AdManager // <-- NEW IMPORT
...
fun DownloaderScreen(
    ...
    activity: Activity, // <-- ADDED: Activity parameter for ad manager
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                Button(
                    onClick = {
                        // --- SHOW AD BEFORE DOWNLOAD LOGIC ---
                        AdManager.showInterstitialAd(activity as ComponentActivity)

                        // Proceed with the original download logic
                        viewModel.downloadMedia(context)
                    },
                    modifier = Modifier.fillMaxWidth(),
                    enabled = !isLoading,
